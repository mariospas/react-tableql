module.exports = (function (e) {
    ...
    function c(e, t) {
      for (var n = {}, a = [], r = 0; r < e.length; r++) {
        ...
        ;-1 !== d
          ...
          : i.push({ identifier: u, updater: v(f, t), references: 1 }),
          a.push(u)
      }
      return a
    }
  ...
  function (e, t, n) {
    ...
    t.default = function (e) {
      var t = e.pagination,
        ...
        F = c.useMemo(
          function () {
            return !((k && 0 !== k.length) || h || void 0 === k)
          },
          [k, h],
        )
      c.useEffect(
        function () {
          D('Data or columns changed: ', { data: m, columns: r })
      ...
      if (void 0 === window || void 0 === document)
        return D('Window or document are not defined.'), null
      if (
        (D('Props: ', {
          pagination: t,
          debug: n,
        ...
        return D('Loading: ', h), c.default.createElement(f.default, null)
      if (v)
        return (
          D('Error: ', v),
          c.default.createElement(
            'p',
            null,
            a || 'Error while loading TableQL: ' + v.message,
          )
        )
      if (Array.isArray(m) && 0 === m.length)
        return (
          D('No data found!', m.length),
          g
            ? g({ reason: 'No data found!' })
            : c.default.createElement('p', null, 'No data found!')
        )
      D('Data: ', m)
      var R = 10
      if (t && w && k) {
        R = 'boolean' != typeof t && t.pageLimit ? t.pageLimit : 10
        var I =
          (j - 1) * ('boolean' != typeof t && t.pageLimit ? t.pageLimit : R)
        if (!k || 0 === k.length)
          return (
            D('No data found to paginate!', k),
            g
              ? g({ reason: 'No data found to paginate!' })
              : c.default.createElement('p', null, 'No data found!')
          )
        var N = w.slice(I).slice(0, R)
        JSON.stringify(k) !== JSON.stringify(N) && O(i([], N))
      }
      return (
        D('Data to be displayed (array): ', k),
        D('Data keys: ', P),
        F
          ? (D('No data found! I am dumb shit', k),
            g
              ? g({ reason: 'No data found!' })
              : c.default.createElement('p', null, 'No data found!'))
          : c.default.createElement(
  ...
  function (e, t, n) {
    ...
    n(20)
    t.default = function () {
      return r.default.createElement('div', { className: 'rtql-loader' })
    }
  },
  function (e, t, n) {
    'use strict'
    ...
    var r = a(n(7)),
      o = a(n(22))
    t.ApolloTableQL = o.default
    var i = a(n(9))
    ;(t.Loader = i.default), (t.default = r.default)
  },
  function (e, t, n) {
    'use strict'
    var a =
    ...
    var l = function (e, t, n) {
      void 0 === n && (n = 1)
      for (var a = e, r = []; a <= t; ) r.push(a), (a += n)
      return r
    }
    t.default = function (e) {
      ...
      ;(i = 'number' == typeof i ? Math.max(0, Math.min(i, 2)) : 0),
        c.useEffect(
          function () {
            ...
            d('Pagination Return Data: ', a({}, e)), u && u(e)
          },
          [v],
        )
      var g = function (e) {
      ...
      var _ = (function () {
        ...
        if (y > e + 2) {
          ...
          return d('Fetch page numbers, pages: ', a), s(s([1], a), [y])
        }
        return d('Fetch page numbers, pages: ', _), l(1, y)
      })()
      return c.default.createElement(
        ...
        _.map(function (e, t) {
          return 'LEFT' === e
            ? c.default.createElement(
                'button',
                { 'aria-label': 'Previous', onClick: E, key: t },
                '«',
              )
            : 'RIGHT' === e
            ? c.default.createElement(
                'button',
                { onClick: j, 'aria-label': 'Next', key: t },
                '»',
              )
            : c.default.createElement(
                'button',
                {
                  ...
                  onClick: function () {
                    return (function (e) {
                      d('Handle pagination page click, page: ', e), g(e)
                    })(e)
                  },
                },
                e,
  ...
  function (e, t, n) {
    ...
    t.default = function (e) {
      ...
      return r.default.createElement(
        'table',
        { className: a.table || 'TableQL' },
        r.default.createElement(
          'thead',
          { className: a.thead || 'TableQL-thead' },
          r.default.createElement(
            'tr',
            { className: a.theadTr || 'TableQL-tr' },
            (function (e) {
              return e.map(function (e, n) {
                return r.default.createElement(
                  'th',
                  {
                    ...
                    onClick: function () {
                      ;('string' == typeof e || e.sort || d || void 0 !== u) &&
        ...
        r.default.createElement(
          'tbody',
          { className: a.tbody || 'TableQL-tbody' },
          (function (e, t) {
            return e.map(function (e) {
              return r.default.createElement(
                'tr',
                {
                  ...
                  className: a.tbodyTr || 'TableQL-tr',
                },
                t.map(function (t, n) {
          ...
          return (
            ...
            'string' != typeof e && e.component
              ...
              ? r.default.createElement(o.default, {
                  src: JSON.parse(JSON.stringify(n)),
                  collapsed: !0,
                  theme: 'monokai',
                })
              : r.default.createElement(
      ...
      (function (e) {
        ...
        function (e, t, n) {
          var a = n(3),
            ...
            c = function (e, t, n) {
              ...
              for (l in (p && (n = t), n))
                ((u = !f && E && void 0 !== E[l]) && s(y, l)) ||
                  ((d = u ? E[l] : n[l]),
                  (y[l] =
                    p && 'function' != typeof E[l]
                      ? n[l]
                      : v && u
                      ? o(d, a)
                      : m && E[l] == d
        ...
        function (e, t, n) {
          ...
          e.exports = function (e, t, n, b, h, v, m) {
            ...
            var y,
              ...
              w = C || j(h),
              S = h ? (x ? j('entries') : w) : void 0,
              A = ('Array' == t && O.entries) || C
            if (
              (A &&
                (E = u(A.call(new e()))) !== Object.prototype &&
                E.next &&
                (l(E, _, !0), a || 'function' == typeof E[d] || i(E, d, p)),
              x &&
                C &&
                'values' !== C.name &&
                ((k = !0),
            ...
            j =
              ((t.createStyling = (0, s.default)(function (e) {
                ...
                var v = h.reduce(function (e, t) {
                  ...
                  E = e(v),
                  _ = y(m, E)
                return (0, s.default)(g, 2).apply(void 0, [_].concat(n))
              }, 3)),
        ...
        function (e, t, n) {
          ...
          var a = n(3),
            ...
            U =
              ...
              l(function () {
                ...
                ? function (e, t, n) {
                    var a = P(V, t)
                    a && delete V[t], M(e, t, n), a && e !== V && M(V, t, a)
                  }
                : M,
            Q = function (e) {
              var t = (z[e] = k(L.prototype))
              return (t._k = e), t
            },
            J =
            ...
            Z = function (e, t) {
              if (
                ((e = j(e)), (t = _(t, !0)), e !== V || !r(z, t) || r(q, t))
              ) {
                var n = P(e, t)
                return (
                  !n || !r(z, t) || (r(e, I) && e[I][t]) || (n.enumerable = !0),
                  n
                )
              }
            },
          ...
          K ||
            (s(
              (L = function () {
                ...
                return o && H && U(V, e, { configurable: !0, set: t }), Q(e)
              }).prototype,
              'toString',
              function () {
                return this._k
            ...
            (n(19).f = Y),
            (w.f = ee),
            o && !n(14) && s(V, 'propertyIsEnumerable', Y, !0),
            (b.f = function (e) {
              return Q(p(e))
            })),
            i(i.G + i.W + i.F * !K, { Symbol: L })
          for (
            var te =
          ...
          i(i.S + i.F * oe, 'Object', {
            ...
            L.prototype[N] || n(6)(L.prototype, N, L.prototype.valueOf),
            d(L, 'Symbol'),
            d(Math, 'Math', !0),
            d(a.JSON, 'JSON', !0)
        },
        function (e, t, n) {
          var a = n(17)('meta'),
            ...
            d = (e.exports = {
              ...
              onFreeze: function (e) {
                return l && d.NEED && c(e) && !o(e, a) && u(e), e
              },
            })
        },
        function (e, t, n) {
        ...
        function (e, t, n) {
          ...
          e.exports =
            ...
            n(8)(function () {
              ...
              ? function (e, t) {
                  for (
                    var n = s(e), l = arguments.length, u = 1, d = o.f, f = i.f;
                    l > u;
                    ...
                    for (
                      var p,
                        b = c(arguments[u++]),
                        h = d ? r(b).concat(d(b)) : r(b),
                        v = h.length,
                        m = 0;
                      v > m;

                    )
                      (p = h[m++]), (a && !f.call(b, p)) || (n[p] = b[p])
                  return n
                }
              : l
        },
          ...
          ;(function (t) {
            ...
            function N(e, t, n, a) {
              for (
                ...
                d[r] = e[r]
              for (var p = r; ++c < l; ) d[p + c] = t[c]
              for (; ++i < s; ) (f || r < o) && (d[p + n[i]] = e[r++])
              return d
            }
            function T(e) {
              return function () {
            ...
            function B(e, t, n, a, r, o, i, s, c, l) {
              var u = 128 & t,
                d = 1 & t,
                f = 2 & t,
                p = 24 & t,
                ...
                v = f ? void 0 : T(e)
              return function m() {
                for (var E = arguments.length, j = Array(E), _ = E; _--; )
                  j[_] = arguments[_]
                if (p)
                  var x = q(m),
                    k = y(j, x)
                if (
                  ...
                  var O = g(j, x)
                  return z(e, t, B, m.placeholder, n, j, O, s, c, l - E)
                }
                var C = d ? n : this,
                  w = f ? C[e] : e
                return (
                  ...
                  u && c < E && (j.length = c),
                  this && this !== h && this instanceof m && (w = v || T(w)),
                  w.apply(C, j)
                )
              }
            }
            function z(e, t, n, a, r, o, i, s, c, l) {
              ...
              return (d.placeholder = a), Q(d, e, t)
            }
            function q(e) {
            ...
            function $(e, t, n) {
              var a = (function (e, t, n, a, r, o, i, s) {
                ...
                if (
                  ...
                  (r = f[4]),
                  !(s = f[9] =
                    null == f[9] ? (c ? 0 : e.length) : F(f[9] - l, 0)) &&
                    24 & t &&
                    (t &= -25),
                  t && 1 != t)
                )
        ...
        function (e, t, n) {
          ...
          function A(e, t, n) {
            return (
              ...
              (function (e) {
                ...
                return (
                  (!1 !== e && 'none' !== e) || (t = O),
                  Object(w.createStyling)(S, { defaultBase16: t })(e)
                )
              })(e)(t, n)
            )
          }
          ...
          B.register(z.handleAction.bind(z))
          var q = z,
            V = (function (e) {
              u(n, e)
              var t = h(n)
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return m.a.createElement(
                        ...
                        m.a.createElement(xe, this.props),
                        m.a.createElement(
                          'span',
                          null,
                          m.a.createElement(
          ...
          var Se = function e(t, n) {
            i(this, e), (this.name = t), (this.value = n), (this.type = x(n))
          }
          j(we)
          var Ae = we,
            Pe = (function (e) {
              ...
              function n(e) {
                ...
                return (
                  ...
                  ((a = t.call(this, e)).closeModal = function () {
                    B.dispatch({ rjvId: a.props.rjvId, name: 'RESET' })
                  }),
                  (a.submit = function () {
                ...
                return (
                  ...
                  (e.submit = function (t) {
                    ...
                    ;(a.new_value = o({}, a.existing_value)),
                      ...
                      B.dispatch({ name: 'VARIABLE_ADDED', rjvId: n, data: a })
                  }),
                  e
                )
              }
      ...
      u = (function (e) {
        ...
        return (
          ...
          (t.prototype.componentDidCatch = function (e, t) {
            this.setState(o(o({}, this.state), { hasError: !0, error: e })),
              console.log(
                'React-TableQL Error: ',
                e,
          ...
          (t.prototype.render = function () {
            ...
            return e.hasError
              ? l.default.createElement(
                  ...
                  l.default.createElement('h1', null, 'Something went wrong!'),
                  l.default.createElement(
                    'p',
                    { style: { color: 'red' } },
                    l.default.createElement('b', null, 'ERROR: '),
                    t.message,
                  ),
                )
              : this.props.children
  ...
  function (e, t, n) {
    ...
    t.traverseObjectForArray = function (e, n) {
      ...
      for (var a in e) {
        if (Array.isArray(e[a])) return e[a]
        if ('object' == typeof e[a]) {
          var r = t.traverseObjectForArray(e[a], !1)
  ...
  function (e, t, n) {
    ...
    t.default = function (e) {
      var t = e.query,
        n = r(e, ['query']),
        o = s.useQuery('string' == typeof t ? s.gql(t) : t, a({}, n)),
        l = o.loading,
        u = o.error,
        d = o.data
      return i.default.createElement(
        c.default,
        a({ loading: l, data: d, error: u }, n),
      )
    }
  },
  function (e, t) {
